const playersData = [
    ...
    { number: 3, name: "함지선", birthdate: "1996.04", position: "RW", height: 158, weight: 52, joinDate: "2017.1.1"},
    { number: 19, name: "김다영", birthdate: "1996.09", position: "LB", height: 170, weight: 56, joinDate: "2020.12.1"},
    { number: 9, name: "정가희", birthdate: "1997.08", position: "LW", height: 155, weight: 49, joinDate: "2016.1.1"},
    { number: 10, name: "송해리", birthdate: "1997.10.", position: "PV", height: 173, weight: 68, joinDate: "2021.8.1"},
    { number: 7, name: "신진미", birthdate: "1998.06", position: "CB", height: 167, weight: 60, joinDate: "2021.1.1"},
